...
public class UserService implements UserDetailsService {
    ...
    @Transactional
    public PlayList addPlaylistToUser(String username, @Valid PlayList playlist) {
    ...
    public Optional<UserInfoResponse> getUserInfo(String username) {// TODO заглушка
        return userRepository.findUserByUsername(username)
                .map(user -> new UserInfoResponse(user.getUsername()));
    }
